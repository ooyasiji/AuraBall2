...
enum AppConfig {
    ...
    static var googleApiKey: String? { value(for: "GOOGLE_TRANSLATE_API_KEY") }
    static var azureApiKey: String? { value(for: "AZURE_TRANSLATE_API_KEY") }
    static var azureRegion: String? { value(for: "AZURE_TRANSLATE_REGION") }

    static var activeTranslator: ActiveTranslator {
        let raw = value(for: "ACTIVE_TRANSLATOR")?.uppercased() ?? "GOOGLE"
